...
void Matrix::SolveLinearASparse(Eigen::SparseMatrix<double>& A_matrix_sparse,std::vector<double>& u,
...
void Matrix::DealBoundary_Sparse(Eigen::SparseMatrix<double>& A_matrix_sparse, std::vector<double>& uh,
